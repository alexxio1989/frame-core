...
public class JdbcUtils {
	...
	public int update(String sql, @Nullable Object... args) throws DataAccessException, SQLException {
	...
	public <T> T queryForObject(String sql, @Nullable Object[] args, RowMapper<T> rowMapper) throws DataAccessException, SQLException{
		T objReturn = jdbcTemplate.queryForObject(sql, args, rowMapper);
		jdbcTemplate.getDataSource().getConnection().close();
		return objReturn;
	}
	
	public Integer queryForInteger(String sql, @Nullable Object[] args) throws DataAccessException, SQLException{
        ...
        update(connection -> {
			...
			for (Object object : objs) {
				if( object instanceof String ) {
					ps.setString(count.intValue() + 1, object != null ? String.valueOf(object) : "");
				}
				if( object instanceof Integer ) {
					ps.setInt(count.intValue() + 1,object != null ? (Integer) object : 0);
				}
